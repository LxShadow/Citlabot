...
let menu =`
 ...
 ┃
 ┃   𝗖𝗿𝗲𝗮𝗱𝗼𝗿 : Citlalyta 🐻 
 ┃   𝗜𝗻𝘀𝘁𝗮𝗴𝗿𝗮𝗺 : citlaaam._
 ┃   𝗪𝗵𝗮𝘁𝘀𝗮𝗽𝗽 : wa.me/528715734733
 ┃   𝗙𝗮𝗰𝗲𝗯𝗼𝗼𝗸 : Ly Citlaam
 ...
 *┃  * _${usedPrefix}blur_
 ...
 ┃   ${usedPrefix}minar𝑳𝒚 𝑩𝒐𝒕coins | minarcoins
 ...
 ┃   ${usedPrefix}dar𝑳𝒚 𝑩𝒐𝒕coins *cantidad*
 ...
 ┃   ${usedPrefix}añadir𝑳𝒚 𝑩𝒐𝒕coins *@tag cantidad*
 ┃
 ╰━━━━━━━ 𝑳𝒚 𝑩𝒐𝒕 ━━━━━━
`.trim()
await conn.sendFile(m.chat, gataImg.getRandom(), 'lp.jpg', menu, fkontak, false, { contextInfo: {mentionedJid, externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: '𝑳𝒚 𝑩𝒐𝒕� 𝗕𝗼𝘁 🐻', previewType: 0, thumbnail: imagen4, sourceUrl: redesMenu.getRandom()}}})
